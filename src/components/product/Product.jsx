    ...
    return (
        <div className={'w-44 sm:w-52 s:w-28 mx-auto flex flex-col justify-end'}>
            ...
            <div className={'mx-4 s:mx-1 mt-1 flex justify-between text-darkBlue'}>
                ...
                <span className={'s:text-sm my-auto underline underline-offset-2'}>
                    {price}
                </span>
            </div>
            <div className={'flex justify-around mt-3 mb-4'}>
                ...
                {modalVisibleInfo &&
                    <Modal setVisibility={setModalVisibleInfo} size={'big'}>
                ...
                {modalVisibleDelete
                    &&
                    <Modal setVisibility={setModalVisibleDelete}>
